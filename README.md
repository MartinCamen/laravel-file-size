...
$size->forHumans(labelStyle: ByteBase::Decimal);   // "5.00 Megabytes"
$size->formatShort();                              // "5.00 MiB"
...
```php
$size = FileSize::megabytes(100, ByteBase::Binary)
    ->addGigabytes(1)
    ->subMegabytes(50)
    ->multiply(2)
    ->divide(4);
...
$size = FileSize::megabytes(500, ByteBase::Binary);
...
$size->format();              // "1.50 Mebibytes"

// Full labels with specific label formatting
$size->forHumans(labelStyle: ByteBase::Binary);        // "1.50 Mebibytes"
$size->forHumans(labelStyle: ByteBase::Decimal);       // "1.50 Megabytes"
$size->format(labelStyle: ByteBase::Binary);           // "1.50 Mebibytes"
$size->format(labelStyle: ByteBase::Decimal);          // "1.50 Megabytes"

// Short labels
$size->forHumans(short: true);  // "1.50 MiB"
$size->formatShort();           // "1.50 MiB"

// Custom precision
$size->forHumans(precision: 0);  // "2 Mebibytes"
$size->forHumans(precision: 4);  // "1.5000 Mebibytes"
```
...
FileSize::kilobytes(1.5)->forHumans();       // "1.50 Kibibytes"
FileSize::megabytes(2.5)->forHumans();       // "2.50 Mebibytes"
FileSize::gigabytes(1.25)->forHumans();      // "1.25 Gibibytes"
```
...
```php
// Binary base (default)
FileSize::megabytes(1, ByteBase::Binary)->forHumans();      // "1.00 Mebibytes"
FileSize::megabytes(1, ByteBase::Binary)->formatShort();    // "1.00 MiB"
...
FileSize::megabytes(1, ByteBase::Decimal)->forHumans(labelStyle: ByteBase::Binary);   // "1.00 Mebibytes"
FileSize::megabytes(1, ByteBase::Decimal)->formatShort(labelStyle: ByteBase::Binary); // "1.00 MiB"
```
...
$size->forHumans();    // "1.1774 Mebibytes"
```
...
return [
    ...
    // Formatting options
    'formatting' => [
        'label_style'                  => null, // null, 'binary' or 'decimal'
        'decimal_separator'            => '.',
        'thousands_separator'          => ',',
